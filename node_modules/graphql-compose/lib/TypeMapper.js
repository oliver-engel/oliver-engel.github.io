...
class TypeMapper {
  ...
  static isOutputType(type) {
    return type instanceof _ScalarTypeComposer.ScalarTypeComposer || type instanceof _ObjectTypeComposer.ObjectTypeComposer || type instanceof _InterfaceTypeComposer.InterfaceTypeComposer || type instanceof _UnionTypeComposer.UnionTypeComposer || type instanceof _EnumTypeComposer.EnumTypeComposer || type instanceof _NonNullComposer.NonNullComposer && TypeMapper.isOutputType(type.ofType) || type instanceof _ListComposer.ListComposer && TypeMapper.isOutputType(type.ofType) || type instanceof _ThunkComposer.ThunkComposer;
  }

  static isInputType(type) {
    return type instanceof _ScalarTypeComposer.ScalarTypeComposer || type instanceof _EnumTypeComposer.EnumTypeComposer || type instanceof _InputTypeComposer.InputTypeComposer || type instanceof _NonNullComposer.NonNullComposer && TypeMapper.isInputType(type.ofType) || type instanceof _ListComposer.ListComposer && TypeMapper.isInputType(type.ofType) || type instanceof _ThunkComposer.ThunkComposer;
  }
  ...
  convertOutputTypeDefinition(typeDef, fieldName = '', typeName = '') {
    if (typeof typeDef === 'string') {
      ...
      if (this.schemaComposer.has(typeDef)) {
        ...
        tc = TypeMapper.isTypeDefinitionString(typeDef) ? this.convertSDLTypeDefinition(typeDef) : this.convertSDLWrappedTypeName(typeDef);
  ...
  convertOutputFieldConfig(composeFC, fieldName = '', typeName = '') {
    try {
      ...
      if ((0, _is.isFunction)(composeFC)) {
        return (0, _createThunkedObjectProxy.createThunkedObjectProxy)(() => this.convertOutputFieldConfig(composeFC(), fieldName, typeName));
  ...
  convertArgConfig(composeAC, argName = '', fieldName = '', typeName = '') {
    try {
      ...
      if ((0, _is.isFunction)(composeAC)) {
        return (0, _createThunkedObjectProxy.createThunkedObjectProxy)(() => this.convertArgConfig(composeAC(), argName, fieldName, typeName));
  ...
  convertInputFieldConfig(composeIFC, fieldName = '', typeName = '') {
    try {
      ...
      if ((0, _is.isFunction)(composeIFC)) {
        return (0, _createThunkedObjectProxy.createThunkedObjectProxy)(() => this.convertInputFieldConfig(composeIFC(), fieldName, typeName));
      } // convert type when its provided as composeIFC
  ...
  convertInterfaceTypeDefinition(typeDef) {
    if (this.schemaComposer.hasInstance(typeDef, _InterfaceTypeComposer.InterfaceTypeComposer)) {
      ...
      const tc = TypeMapper.isInterfaceTypeDefinitionString(typeDef) ? this.convertSDLTypeDefinition(typeDef) : this.convertSDLWrappedTypeName(typeDef);
